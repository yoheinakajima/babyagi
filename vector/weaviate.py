...
from .IVector import ContextStorage, ContextResult, ContextData
...
class Weaviate(ContextStorage):
    ...
    class WeaviateOptions:
        ...
        def __init__(
            ...
            print(host)
            self.host = host
            self.vectorizer = "text2vec-contextionary"
            self.storage_name = "tasks"
    ...
    def __init__(self, options: Optional[WeaviateOptions] = None):     
        ...
        self._create_storage(options.storage_name, options.vectorizer)
