        ...
        dbc.Modal(
            [
                ...
                dbc.ModalBody([
                    ...
                    - 🐱‍💻 Code generation models have the potential to significantly accelerate malware development, enabling malicious actors to launch more sophisticated and effective cyberattacks. These tools may also help lower the intellectual/technique barrier that prevents many people from getting into black hat hacking.
                    ...
                    - 🚀 In terms of long-term AI safety, generalist and multi-task models, which are capable of carrying out a variety of tasks (moving AI development closer to Artificial General Intelligence), may present unknown risks. Additionally, models that have programming abilities could be dangerous because they could enable AI systems to modify or rewrite their source code.
                    
                    - 👷 A significant portion of the workforce today still performs many tasks that can be automated using generative models. In some industries, these models might provoke considerable labor displacement.
                    
                    - 👨‍🎓 Generative models can automate the process of academic writing and creation. This could have an impact on how educational institutions assess the learning of their students. Dishonest students could use such models to completely automate their tasks instead of using them as augmenting tools.
                    ''',
                                 className='modal-body-text-style', style={'font-size': FONT_SIZE}), html.Br(),
                ]),
                dbc.ModalFooter(
