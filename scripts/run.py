...
first_task = {
    "task_id": 1,
    "task_name": config["project"]["first_task"]  # Replace this with the actual task name
}
...
while True:
    ...
    new_tasks = ai_assistant.task_creation_agent(OBJECTIVE, result, task["task_name"], [t["task_name"] for t in task_manager.task_list])
