...
4. Set your OpenAI API keys in the OPENAI_API_KEY and OPENAPI_API_MODEL variables.
5. Select a vector database type for your context storage by setting the CONTEXT_STORAGE_TYPE variable.
  a. Configure Pinecone by setting the PINECONE_API_KEY and PINECONE_ENVIRONMENT variables.
  b. Configure Weaviate by setting the WEAVIATE_HOST and WEAVIATE_VECTORIZER variables.
6. Set the name of the context storage where the task results will be stored in the TASK_STORAGE_NAME variable.
